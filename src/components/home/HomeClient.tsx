      ...
      >
        ...
        <header className="min-h-[90vh] lg:min-h-screen flex flex-col items-center justify-center relative px-6 py-16 lg:py-20">
          <div className="flex flex-col items-center reveal max-w-6xl mx-auto">
            ...
            {/* Main Title - Using proper h1 for SEO */}
            ...
            {/* Korean Title */}
            <p className="text-[#f43f5e] text-base md:text-lg font-body tracking-[0.3em] font-light subpixel-antialiased" lang="ko">
              너에게 빼앗을 왕관
            </p>
          </div>
        ...
        <article className="max-w-4xl mx-auto px-6 md:px-8 relative z-10" itemScope itemType="https://schema.org/Book">
          ...
          <section className="mb-20 reveal" aria-labelledby="credits-heading">
            ...
            <div className="bg-neutral-900/40 border border-neutral-800/60 rounded-xl p-8 md:p-10 shadow-2xl">
              <dl className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
                <div>
                  <dt className="text-[9px] font-ui tracking-[0.35em] uppercase text-neutral-500 mb-3 font-light subpixel-antialiased">
                    Author
                  </dt>
                  <dd>
                    <span className="font-heading text-lg text-neutral-100 mb-1 subpixel-antialiased block" itemProp="author" itemScope itemType="https://schema.org/Person">
                      <span itemProp="name">Wilbright</span>
                    </span>
                    <span className="text-sm text-neutral-500 font-body subpixel-antialiased" lang="ko">윌브라이트</span>
                  </dd>
                </div>
                <div>
                  <dt className="text-[9px] font-ui tracking-[0.35em] uppercase text-neutral-500 mb-3 font-light subpixel-antialiased">
                  ...
                  <dd>
                    <span className="font-heading text-lg text-neutral-100 mb-1 subpixel-antialiased block" itemProp="illustrator" itemScope itemType="https://schema.org/Person">
                      <span itemProp="name">Pilyeon</span>
                    </span>
                    <span className="text-sm text-neutral-500 font-body subpixel-antialiased" lang="ko">필연</span>
                  </dd>
                </div>
                <div>
                  <dt className="text-[9px] font-ui tracking-[0.35em] uppercase text-neutral-500 mb-3 font-light subpixel-antialiased">
                  ...
                  <dd>
                    <span className="font-heading text-lg text-neutral-100 mb-1 subpixel-antialiased block">Korean</span>
                    <span className="text-sm text-neutral-500 font-body subpixel-antialiased">English TL</span>
                  </dd>
                </div>
                <div>
                  <dt className="text-[9px] font-ui tracking-[0.35em] uppercase text-neutral-500 mb-3 font-light subpixel-antialiased">
                  ...
                  <dd>
                    <time className="font-heading text-lg text-neutral-100 mb-1 subpixel-antialiased block" itemProp="datePublished" dateTime="2024">2024</time>
                    <span className="text-sm text-neutral-500 font-body subpixel-antialiased">Ongoing</span>
                  </dd>
                </div>
              </dl>
            </div>
          ...
          <nav className="mb-20 reveal" aria-label="Genre tags">
            <ul className="flex flex-wrap justify-center gap-3" itemProp="genre">
              {["Fantasy", "Regression", "Revenge", "Romance", "Drama"].map((tag) => (
                <li key={tag}>
                  <span
                    className="px-5 py-2.5 border border-[#9f1239]/30 rounded-full text-[10px] font-ui tracking-[0.25em] uppercase text-[#9f1239] bg-[#4c0519]/10 hover:bg-[#4c0519]/20 hover:border-[#9f1239]/50 transition-all duration-300 font-light subpixel-antialiased inline-block"
                  >
                    {tag}
                  </span>
                </li>
          ...
          <section className="prose prose-invert prose-lg md:prose-xl max-w-none reveal" aria-labelledby="synopsis-heading">
            <div className="mb-10 px-5 py-2 border border-amber-900/30 rounded-full bg-amber-950/10 inline-block">
              <h2 id="synopsis-heading" className="text-amber-200/60 text-[9px] font-ui tracking-[0.45em] uppercase font-light subpixel-antialiased m-0">
                Synopsis
              </h2>
            </div>
            ...
            <div className="mt-20 mb-24 relative">
              ...
              <div className="relative bg-black/80 border border-slate-700/50 p-10 md:p-14 rounded-xl text-center">
                <h3 className="text-3xl md:text-4xl font-heading text-neutral-200 mb-8 tracking-wide leading-tight subpixel-antialiased">
                  To get my revenge,
                </h3>
          ...
          <nav className="mt-24 mb-40 flex flex-col sm:flex-row gap-5 justify-center reveal" aria-label="Reading actions">
            ...
            <button 
              className="group relative px-14 py-4 font-heading tracking-[0.25em] uppercase text-sm overflow-hidden rounded-lg border border-neutral-700 bg-transparent text-neutral-400 hover:text-white hover:border-neutral-500 transition-all duration-300 subpixel-antialiased"
