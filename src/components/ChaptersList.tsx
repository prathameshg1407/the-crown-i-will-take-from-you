...
import { useRouter } from "next/navigation"  // ✅ Only this one
...
export default function ChaptersList() {
  ...
  const handleOpenChapter = useCallback((slug: string) => {
    setActiveChapter(slug)
  }, [])
  ...
  // Calculate stats
  const freeCount = PRICING.FREE_CHAPTERS
  const premiumCount = 386 - freeCount
      ...
      <section id="chapters" className="max-w-4xl mx-auto px-6 md:px-8 py-20">
        ...
        <div className="space-y-6">
          ...
          <ChapterGroup
            ...
            description="Chapters 82-386 • Complete Story Pack"
            chaptersList={chapters.filter(ch => ch.id > PRICING.FREE_CHAPTERS)}
            userTier={userTier}
            ownedChapters={ownedChapters}
            router={router}
...
function ChapterGroup({
  ...
  return (
    <div className={`border border-neutral-800/60 rounded-xl overflow-hidden bg-neutral-900/20 reveal border-l-4 ${colorScheme.accent}`}>
      {/* Header */}
      <button
      ...
      >
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2 flex-wrap">
            ...
            <span className="text-neutral-600 text-sm font-ui">
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    {/* Chapter Number */}
                    <div className={`flex-shrink-0 w-11 h-11 md:w-12 md:h-12 rounded-lg flex items-center justify-center font-heading text-sm border transition-colors ${
                      locked
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h4 className={`text-sm font-heading truncate transition-colors ${
                        locked 
                          ? "text-neutral-500" 
